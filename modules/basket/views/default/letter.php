...
<?php if(count($products)){ ?>
    ...
    <div class="row center">
        ...
        Информацию по вашему заказа можно посмотреть по ссылке:
        <a href="<?= 'http://' . $_SERVER['SERVER_NAME'] . '/order/?order_key=' . $model->order_key ?>" >
        <?= 'http://' . $_SERVER['SERVER_NAME'] . '/order/?order_key=' . $model->order_key ?></a>
        </p>
    </div>
<?php } ?>